...
function Question3() {
    const items = ['q401', 'q402', 'q403', 'q404', 'q405', 'q406', 'q407', 'q408', 'q409', 'q410'];
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/data4/${randomItem}`)
            .then((response) => {
    ...
    useEffect(() => {
        if (user) {
            axios.get(`http://localhost:3001/scoreget4/${user}`)
                .then((res) => {
                    const data = res.data[0].gate4;
    ...
    const checkanswer = (e) => {
        ...
        if (userAnswer === answer) {
            ...
            console.log(fscore);
            axios.put(`http://localhost:3001/edit4/${user}`, { gate4: fscore })
                .then((response) => {
