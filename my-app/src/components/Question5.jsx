...
function Question3() {
    const items = ['q501', 'q502', 'q503', 'q504', 'q505', 'q506', 'q507', 'q508', 'q509', 'q510'];
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/data5/${randomItem}`)
            .then((response) => {
    ...
    useEffect(() => {
        if (user) {
            axios.get(`http://localhost:3001/scoreget5/${user}`)
                .then((res) => {
                    const data = res.data[0].gate5;
    ...
    const checkanswer = (e) => {
        ...
        if (userAnswer === answer) {
            ...
            console.log(fscore);
            axios.put(`http://localhost:3001/edit5/${user}`, { gate5: fscore })
                .then((response) => {
