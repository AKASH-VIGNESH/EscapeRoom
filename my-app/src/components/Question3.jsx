...
function Question3() {
    const items = ['q301', 'q302', 'q303', 'q304', 'q305', 'q306', 'q307', 'q308', 'q309', 'q310'];
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/data3/${randomItem}`)
            .then((response) => {
    ...
    useEffect(() => {
        if (user) {
            axios.get(`http://localhost:3001/scoreget3/${user}`)
                .then((res) => {
                    const data = res.data[0].gate3;
    ...
    const checkanswer = (e) => {
        ...
        if (userAnswer === answer) {
            ...
            console.log(fscore);
            axios.put(`http://localhost:3001/edit3/${user}`, { gate3: fscore })
                .then((response) => {
