...
function Question2() {
    const items = ['q201', 'q202', 'q203', 'q204', 'q205', 'q206', 'q207', 'q208', 'q209', 'q210'];
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/data2/${randomItem}`)
            .then((response) => {
    ...
    useEffect(() => {
        if (user) {
            axios.get(`http://localhost:3001/scoreget2/${user}`)
                .then((res) => {
                    const data = res.data[0].gate2;
    ...
    const checkanswer = (e) => {
        ...
        if (userAnswer === answer) {
            ...
            console.log(fscore);
            axios.put(`http://localhost:3001/edit2/${user}/`, { gate2: fscore })
                .then((response) => {
